...
export const Mv: React.FC = () => {
  ...
  return (
    <>
      <div data-ref={mvInView} ref={ref}>
        <Inner className="relative mb-6 border-t-[3px] border-(--color-primary) bg-[url('/img/sp_mv_bg.webp')] bg-no-repeat bg-[length:100%_auto] md:bg-[url('/img/pc_mv_bg.webp')] md:bg-cover p-0!">
          ...
          <section>
            <h2 className="w-[91%] mx-auto pt-[34%] md:w-[650px] md:pt-[230px]">
              <img
